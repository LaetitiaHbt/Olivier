            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <h2 class="page-title">Mon histoire</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="index.php"><i class="icon_house_alt"></i> Accueil</a></li>
                                <li class="breadcrumb-item active" aria-current="page">A propos de moi</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    <div class="about-us-content mb-80">
                        <h3 class="wow fadeInUp" data-wow-delay="100ms">Je vis pour ma passion</h3>
                        ...
                        <a class="btn alime-btn btn-2 mt-30 wow fadeInUp" data-wow-delay="500ms" href="#">Contactez-moi</a>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="why-choose-us-content text-center mb-80 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <h4>Images de hautes qualités</h4>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xl-6">
                    <div class="team-content-area text-center mb-30 wow fadeInUp" data-wow-delay="300ms">
                        <div class="member-thumb">
                            <img src="img/bg-img/olivier.jpg" alt="">
                        </div>
                        <h5>Olivier Prevot</h5>
                ...
                <div class="col-md-6 col-xl-6">
                    <div class="team-content-area text-center mb-30 wow fadeInUp" data-wow-delay="500ms">
                        <div class="member-thumb">
                            <img src="img/bg-img/laetitia.jpg" alt="">
                        </div>
                        <h5>Laetitia Habert</h5>
